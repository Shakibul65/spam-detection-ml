...
if 'models_loaded' not in st.session_state:
    try:
        # এখানে আপনার আসল ডাটাসেট ফাইলটি লোড হবে
        df = pd.read_csv('phishing_dataset.csv') 
        st.sidebar.info("🎯 Loaded: Real Thesis Dataset")
    except FileNotFoundError:
        # ফাইল মিসিং থাকলে এই ব্যাকআপ ব্যালেন্সড মক ডাটাসেটটি কাজ করবে
        data = {
            'url': [
        ...
        st.sidebar.warning("⚠️ Using Backup Dataset (phishing_dataset.csv not found)")
