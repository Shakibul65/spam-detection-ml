...
# ২. অ্যাডভান্সড সিএসএস (ডিজাইন ও এনিমেশন)
st.markdown("""
    <style>
    ...
    .icon-img { width: 80px; margin-bottom: 15px; }
    </style>
...
with st.sidebar:
    ...
    st.caption("UI: Sound & Glowing Icons")

# ৫. মেইন কন্টেন্ট
st.markdown("<h1 style='text-align: center;'>🚀 Smart AI Spam Shield</h1>", unsafe_allow_html=True)
st.markdown("<p style='text-align: center; color: #94a3b8;'>অত্যাধুনিক মেশিন লার্নিং প্রযুক্তি দিয়ে আপনার মেসেজ যাচাই করুন।</p>", unsafe_allow_html=True)

col1, col2, col3 = st.columns([0.1, 0.8, 0.1])

with col2:
    st.markdown('<div class="glass-card">', unsafe_allow_html=True)
    user_input = st.text_area("মেসেজটি এখানে লিখুন:", height=180, placeholder="Paste your message here...")
            ...
            if prediction[0] == 'spam':
                ...
                st.markdown(f"""
                    <div class="spam-result">
                        ...
                        <p style="font-size: 18px;">নিশ্চয়তা: <b>{confidence:.2f}%</b></p>
                    </div>
                """, unsafe_allow_html=True)
                st.snow()
            else:
...
with c2:
    st.markdown('<div class="glass-card" style="text-align: center;"><h3>⚡ Speed</h3><p>মিলি-সেকেন্ডে ফলাফল।</p></div>', unsafe_allow_html=True)
with c3:
